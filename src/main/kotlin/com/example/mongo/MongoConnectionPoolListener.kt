...
open class MongoConnectionPoolListener(
...
//        waitQueueSize[event.serverId]?.incrementAndGet()
//    }
//
//    override fun waitQueueExited(event: ConnectionPoolWaitQueueExitedEvent) {
//        waitQueueSize[event.serverId]?.decrementAndGet()
//    }
    ...
    override fun toString(): String {
        return ("McoreMongoConnectionPoolListener{" +
                "poolSize='" + poolSize() + '\'' +
